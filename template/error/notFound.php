...
<head>
    ...
    <link rel="stylesheet" href="<?= basetemplateUrl('error/assets/css/style.css') ?>">
...
<div id="wrap">
 ...
 <script src="<?= basetemplateUrl('error/assets/js/jquery.js') ?>"></script>
 <script src="<?= basetemplateUrl('error/assets/js/javascript.js') ?>"></script>
</body>
</html>